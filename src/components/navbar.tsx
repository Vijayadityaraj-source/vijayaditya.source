...
export default function navbar(){
    ...
    useEffect(() => {
        ...
        theme?setMenuClass("material-icons md-light md-32"):setMenuClass("material-icons md-dark md-32");
    ...
    return (
        <div className="navbar">
            <nav className={navClass}>
                ...
                <Link className="hide" style={{color: contactTextColor,textDecoration: 'none',padding: 0,margin: "auto 0"}} href="/Contact"><p className="contactLink">Contact</p></Link>
                <button onClick={changeMode} onMouseOver={handleHover} onMouseOut={handleHover_} className="toggle-button">{theme ? <span className={iconClassDark}>&#xe51c;</span> : <span className={iconClassLight}>&#xe518;</span>}</button>
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <button onClick={openMenu} className="toggle-menu"><span className={menuClass}>&#xe5d2;</span></button>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent>
                        <DropdownMenuLabel>Menu</DropdownMenuLabel>
                        <DropdownMenuSeparator />
                        <DropdownMenuRadioGroup value={position} onValueChange={setPosition}>
                            <Link  style={{textDecoration: 'none',padding: 'auto',margin: "auto"}} href="/"><DropdownMenuRadioItem value="home">Home</DropdownMenuRadioItem></Link>
                            <Link  style={{textDecoration: 'none',padding: "auto",margin: "auto"}} href="/About"><DropdownMenuRadioItem value="about">About</DropdownMenuRadioItem></Link>
                            <Link  style={{textDecoration: 'none',padding: "auto",margin: "auto"}} href="/Showcase"><DropdownMenuRadioItem value="showcase">Showcase</DropdownMenuRadioItem></Link>
                            <Link  style={{textDecoration: 'none',padding: "auto",margin: "auto"}} href="/Contact"><DropdownMenuRadioItem value="contact">Contact</DropdownMenuRadioItem></Link>
                        </DropdownMenuRadioGroup>
                    </DropdownMenuContent>
                </DropdownMenu>
            </nav>
